...
VMs create isolated environments on the host machine that behave like separate machines,
where separate operating systems and platform-independent process can be run.
